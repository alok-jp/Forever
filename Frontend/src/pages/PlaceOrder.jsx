      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            ...
            <div onClick={() => setMethod('stripe')} className="flex items-center cursor-pointer gap-3 border p-2 px-3 border-gray-300">
              <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-300 ${method === 'stripe' ? 'bg-green-600' :''}`}></p>
              <img className="h-5 mx-4" src={assets.stripe_logo} alt="" />
            </div>

            <div onClick={() => setMethod('razorpay')} className="flex items-center cursor-pointer gap-3 border p-2 px-3 border-gray-300">
              <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-300 ${method === 'razorpay' ? 'bg-green-600' :''}`}></p>
              <img className="h-5 mx-4" src={assets.razorpay_logo} alt="" />
            </div>

            <div onClick={() => setMethod('cod')} className="flex items-center cursor-pointer gap-3 border p-2 px-3 border-gray-300">
              <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-300 ${method === 'cod' ? 'bg-green-600' :''}`}></p>
