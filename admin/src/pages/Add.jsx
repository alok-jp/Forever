    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div>
            ...
            <div className='flex gap-2'>
                <label className='w-20 flex flex-col text-transparent' htmlFor="image1">
                    <img className='w-20' src={!image1? assets.upload_area : URL.createObjectURL(image1)} alt="" />
                    <input onChange={(e) => setImage1(e.target.files[0])} className='' type="file" id="image1"  />
                </label>
                <label className='w-20 flex flex-col text-transparent' htmlFor="image2">
                    <img className='w-20' src={!image2? assets.upload_area : URL.createObjectURL(image2)} alt="" />
                    <input onChange={(e) => setImage2(e.target.files[0])} type="file"  id="image2"  />
                </label>
                <label className='w-20 flex flex-col text-transparent'  htmlFor="image3">
                    <img className='w-20' src={!image3? assets.upload_area : URL.createObjectURL(image3)} alt="" />
                    <input onChange={(e) => setImage3(e.target.files[0])} type="file"  id="image3"  />
                </label>
                <label className='w-20 flex flex-col text-transparent'  htmlFor="image4">
